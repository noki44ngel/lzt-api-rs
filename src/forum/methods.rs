...
impl crate::forum::ForumApi {
    ...
    /// Get CSS
    /// `GET /css`
    pub async fn assets_css(&self, css: Option<Vec<String>>) -> Result<serde_json::Value> {
    ...
    /// Get Access Token
    /// `POST /oauth/token`
    pub async fn o_auth_token(&self) -> Result<serde_json::Value> {
        self.client
            .request(
                "post",
                "/oauth/token",
    ...
    /// Batch
    /// `POST /batch`
    pub async fn batch_execute(&self) -> Result<serde_json::Value> {
        self.client
            .request(
                "post",
                "/batch",
    ...
    pub async fn categories_get(&self, category_id: i64) -> Result<serde_json::Value> {
        self.client
            .request(
                "get",
    ...
    /// `GET /chatbox/ignore`
    pub async fn chatbox_get_ignore(&self) -> Result<serde_json::Value> {
        self.client
            .request(
                "get",
                "/chatbox/ignore",
    ...
    pub async fn chatbox_online(&self, room_id: serde_json::Value) -> Result<serde_json::Value> {
        let mut query: Vec<(&str, String)> = Vec::new();
        query.push(("room_id", room_id.to_string()));
        self.client
            .request(
    ...
    pub async fn chatbox_report_reasons(&self, message_id: i64) -> Result<serde_json::Value> {
        let mut query: Vec<(&str, String)> = Vec::new();
    ...
    /// `GET /tags/find`
    pub async fn tags_find(&self, tag: String) -> Result<serde_json::Value> {
        let mut query: Vec<(&str, String)> = Vec::new();
    ...
    /// Get Popular Tags
    /// `GET /tags`
    pub async fn tags_popular(&self) -> Result<serde_json::Value> {
        self.client
            .request(
                "get",
                "/tags",
    ...
    pub async fn conversations_get(&self, conversation_id: i64) -> Result<serde_json::Value> {
        self.client
            .request(
                "get",
    ...
    pub async fn conversations_messages_get(&self, message_id: i64) -> Result<serde_json::Value> {
        self.client
            .request(
                "get",
    ...
    pub async fn conversations_read_all(&self) -> Result<serde_json::Value> {
        self.client
            .request(
                "post",
    ...
    pub async fn conversations_star(&self, conversation_id: i64) -> Result<serde_json::Value> {
        self.client
            .request(
                "post",
    ...
    pub async fn conversations_unstar(&self, conversation_id: i64) -> Result<serde_json::Value> {
        self.client
            .request(
                "delete",
                &format!("/conversations/{conversation_id}/star"),
    ...
    /// Create Form
    /// `POST /forms/save`
    pub async fn forms_create(&self) -> Result<serde_json::Value> {
        self.client
            .request(
                "post",
                "/forms/save",
    ...
    /// Get Forms List
    /// `GET /forms`
    pub async fn forms_list(&self, page: Option<i64>) -> Result<serde_json::Value> {
        let mut query: Vec<(&str, String)> = Vec::new();
        if let Some(v) = &page {
            query.push(("page", v.to_string()));
        }
    ...
    /// Get Followed Forums
    /// `GET /forums/followed`
    pub async fn forums_followed(&self, total: Option<bool>) -> Result<serde_json::Value> {
        let mut query: Vec<(&str, String)> = Vec::new();
        if let Some(v) = &total {
    ...
    pub async fn forums_followers(&self, forum_id: i64) -> Result<serde_json::Value> {
        self.client
            .request(
                "get",
                &format!("/forums/{forum_id}/followers"),
    ...
    /// Get Forum
    /// `GET /forums/{forum_id}`
    pub async fn forums_get(&self, forum_id: i64) -> Result<serde_json::Value> {
        self.client
            .request(
                "get",
    ...
    pub async fn forums_get_feed_options(&self) -> Result<serde_json::Value> {
        self.client
            .request(
                "get",
                "/forums/feed/options",
    ...
    /// Get Forums Tree
    /// `GET /forums/grouped`
    pub async fn forums_grouped(&self) -> Result<serde_json::Value> {
        self.client
            .request(
                "get",
                "/forums/grouped",
    ...
    pub async fn links_get(&self, link_id: i64) -> Result<serde_json::Value> {
        self.client
            .request(
                "get",
    ...
    /// Get Links Forum
    /// `GET /link-forums`
    pub async fn links_list(&self) -> Result<serde_json::Value> {
        self.client
            .request(
                "get",
                "/link-forums",
    ...
    /// Get Navigation
    /// `GET /navigation`
    pub async fn navigation_list(&self, parent: Option<i64>) -> Result<serde_json::Value> {
        let mut query: Vec<(&str, String)> = Vec::new();
    ...
    pub async fn notifications_get(&self, notification_id: i64) -> Result<serde_json::Value> {
        self.client
            .request(
                "get",
    ...
    /// Get Page
    /// `GET /pages/{page_id}`
    pub async fn pages_get(&self, page_id: i64) -> Result<serde_json::Value> {
        self.client
            .request(
                "get",
    ...
    /// Get Post
    /// `GET /posts/{post_id}`
    pub async fn posts_get(&self, post_id: i64) -> Result<serde_json::Value> {
        self.client
            .request(
                "get",
                &format!("/posts/{post_id}"),
    ...
    /// Get Posts
    /// `GET /posts`
    pub async fn posts_list(&self, params: ForumPostsListParams) -> Result<serde_json::Value> {
        let mut query: Vec<(&str, String)> = Vec::new();
    ...
    pub async fn posts_report_reasons(&self, post_id: i64) -> Result<serde_json::Value> {
        self.client
            .request(
                "get",
                &format!("/posts/{post_id}/report"),
    ...
    pub async fn profile_posts_get(&self, profile_post_id: i64) -> Result<serde_json::Value> {
        self.client
            .request(
                "get",
                &format!("/profile-posts/{profile_post_id}"),
    ...
    pub async fn profile_posts_likes(&self, profile_post_id: i64) -> Result<serde_json::Value> {
        self.client
            .request(
                "get",
                &format!("/profile-posts/{profile_post_id}/likes"),
    ...
    /// Search
    /// `POST /search`
    pub async fn search_all(&self, params: ForumSearchAllParams) -> Result<serde_json::Value> {
        let mut body = serde_json::Map::new();
    ...
    /// Search Post
    /// `POST /search/posts`
    pub async fn search_posts(&self, params: ForumSearchPostsParams) -> Result<serde_json::Value> {
        let mut body = serde_json::Map::new();
    ...
    /// Search Users
    /// `POST /search/users`
    pub async fn search_users(&self, q: Option<String>) -> Result<serde_json::Value> {
        let mut body = serde_json::Map::new();
        if let Some(v) = &q {
            body.insert("q".into(), serde_json::to_value(v).unwrap_or_default());
        }
    ...
    pub async fn threads_bump(&self, thread_id: i64) -> Result<serde_json::Value> {
        self.client
            .request(
                "post",
    ...
    pub async fn threads_followers(&self, thread_id: i64) -> Result<serde_json::Value> {
        self.client
            .request(
                "get",
                &format!("/threads/{thread_id}/followers"),
    ...
    pub async fn threads_hide(&self, thread_id: i64) -> Result<serde_json::Value> {
        self.client
            .request(
                "post",
    ...
    /// Get Threads
    /// `GET /threads`
    pub async fn threads_list(&self, params: ForumThreadsListParams) -> Result<serde_json::Value> {
        let mut query: Vec<(&str, String)> = Vec::new();
        if let Some(v) = &params.forum_id {
    ...
    pub async fn threads_navigation(&self, thread_id: i64) -> Result<serde_json::Value> {
        self.client
            .request(
                "get",
    ...
    pub async fn threads_poll_get(&self, thread_id: i64) -> Result<serde_json::Value> {
        self.client
            .request(
                "get",
    ...
    /// Get User Fields
    /// `GET /users/fields`
    pub async fn users_fields(&self) -> Result<serde_json::Value> {
        self.client
            .request(
                "get",
                "/users/fields",
    ...
    /// Get Ignored Users
    /// `GET /users/ignored`
    pub async fn users_ignored(&self, total: Option<bool>) -> Result<serde_json::Value> {
        let mut query: Vec<(&str, String)> = Vec::new();
        if let Some(v) = &total {
            query.push(("total", v.to_string()));
        }
    ...
    pub async fn users_sa_reset(&self) -> Result<serde_json::Value> {
        self.client
            .request(
                "post",
                "/account/secret-answer/reset",
    ...
    pub async fn users_secret_answer_types(&self) -> Result<serde_json::Value> {
        self.client
            .request(
                "get",
    ...
    pub async fn users_trophies(&self, user_id: i64) -> Result<serde_json::Value> {
        self.client
            .request(
                "get",
